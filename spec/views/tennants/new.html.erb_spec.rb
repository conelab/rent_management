...
RSpec.describe "tennants/new", :type => :view do
  before(:each) do
    assign(:tennant, Tennant.new(
      :property_id => 1,
      :name => "MyString",
      :username => "MyString",
  ...
  it "renders new tennant form" do
    render

    assert_select "form[action=?][method=?]", tennants_path, "post" do
